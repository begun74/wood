...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="${vmc.model}">
...
<!--                        <li class="dropdown breadcrumb-item">
                        ...
                        <li class="breadcrumb-item">
                            <a href="drill-end-mill-grinder">Grinders</a>
                        </li> 
                        <!--/.breadcrumb-item--> 

                        <li class="breadcrumb-item current">
                            <a href="">${grinder.type} - ${grinder.model}</a>
                        </li> 
                        <!--/.breadcrumb-item--> 
                    </ul>
                </li> 
    ...
    <div class="product-item-holder size-big single-product-gallery small-gallery">
        ...
        <div id="owl-single-product">
            <div class="single-product-gallery-item" id="slide1">
                <!--<a data-rel="prettyphoto" href="resources/assets/images/products/${grinder.photo1}">-->
                <a data-rel="prettyphoto" href="resources/jpg_grider/${grinder.photo1}">
                    <img class="img-responsive" alt="" 
                         src="${grinder.photo1}" 
                         data-echo="resources/jpg_grider/${grinder.photo1}" />
                         <!--src="resources/assets/images/products/${grinder.photo1}"--> 
                         <!--data-echo="resources/assets/images/products/${grinder.photo1}" />-->
        ...
        <div class="single-product-gallery-thumbs gallery-thumbs">
            ...
            <div id="owl-single-product-thumbnails">
                <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="0" href="#slide1">
                    <!--<img width="67" alt="" src="resources/assets/images/blank.gif" data-echo="resources/assets/images/products/bench${grinder.id}.jpg" />-->
                    <!--<img width="67" alt="" src="resources/assets/images/products/${grinder.photo1}" data-echo="resources/assets/images/products/${grinder.photo1}" />-->
                    <img width="67" alt="" src="resources/jpg_grider/${grinder.photo1}" data-echo="resources/jpg_grider/${grinder.photo1}" />
                </a>
...
<!--                <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="1" href="#slide2">
                    ...
                    <img width="67" alt=""  src="resources/assets/images/products/${vmc.photo2}" data-echo="resources/assets/images/products/${vmc.photo2}"  />
                </a>
                ...
                <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="2" href="#slide3">
                    ...
                    <img width="67" alt=""  src="resources/assets/images/products/${vmc.photo3}" data-echo="resources/assets/images/products/${vmc.photo3}"  />
                </a>

                <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="3" href="#slide4">
                    <img width="67" alt="" src="resources/assets/images/blank.gif" data-echo="resources/assets/images/products/bench${vmc.id}.jpg" />
                    <img width="67" alt=""  src="resources/assets/images/products/${vmc.photo4}" data-echo="resources/assets/images/products/${vmc.photo4}"  />
                </a>

                <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="4" href="#slide5">
                    <img width="67" alt="" src="resources/assets/images/blank.gif" data-echo="resources/assets/images/products/bench${vmc.id}.jpg" />
                    <img width="67" alt=""  src="resources/assets/images/products/${vmc.photo5}" data-echo="resources/assets/images/products/${vmc.photo5}"  />
                </a>-->
...
<!--                <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="2" href="#slide3">
    ...
    <div class="body">
        ...
        <div class="title"><a href="#">${grinder.type} - ${grinder.model}</a></div>
...
<!--        <div class="buttons-holder">
        ...
        <div class="excerpt">
            <p>${grinder.designed}</p>
            <p>${grinder.description}</p>
        </div>
...
<!--            <div class="le-quantity">
            ...
            <!--<a id="addto-cart" href="add-product-to-customer-basket.htm?id=${grinder.id}" class="le-button huge">add to cart</a>-->
        </div><!-- /.qnt-holder -->
    </div><!-- /.body -->
...
<section id="single-product-tab">
    ...
    <c:choose>
        <c:when test="${empty grinder.video}">       
             <iframe width="560" height="315" src="https://www.youtube.com/embed/X3s_fNoro7I" frameborder="0" allowfullscreen></iframe>              
        </c:when>

        <c:otherwise>
           <iframe width="560" height="315" src="${grinder.video}" frameborder="0" allowfullscreen></iframe>
           <br>
        </c:otherwise>
    </c:choose>          
...
<!--                    <div class="meta-row">
                ...
                <div class="tab-pane" id="additional-info">
                    <ul class="tabled-data">
                        <li>
                            <label>Model</label>
                            <div class="value">${grinder.model}</div>
                        </li>
                        <li>
                            <label>Type</label>
                            <div class="value">${grinder.type}</div>
                        </li>
                        <li>
                            <label>Country:</label>
                            <div class="value">${grinder.country}</div>
                        </li>
                        <li>
                            <label>For: </label>
                            <div class="value">${grinder.tool}</div>
                        </li>
                        <li>
                            <label>Diameter</label>
                            <div class="value">${grinder.diametermax}...${grinder.diametermin}</div>
                        </li>
                        <li>
                            <label>Angle</label>
                            <div class="value">${grinder.angle}</div>
                        </li>
                        <li>
                            <label>power supply</label>
                            <div class="value">${grinder.powersupply}</div>
                        </li>
                        <li>
                            <label>grinder speed</label>
                            <div class="value">${grinder.grinderspeed}</div>
                        </li>
                        <li>
                            <label>spindle speed</label>
                            <div class="value">${grinder.spindlespeed}</div> 
                        </li>
                        <li>
                            <label>grinding whell</label>
                            <div class="value">${grinder.grindingwhell}</div>
                        </li>
