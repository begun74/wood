                ...
                <section class="section leave-a-message">
                    ...
                    <!--<form id="contact-form" class="contact-form cf-style-1 inner-top-xs" method="post" >-->
                        ...
                        <div class="field-row">
                          ...
                          <br>  <label> <a href="cnc-milling-machine">Cnc milling machines</a> </label>
                            <c:forEach items="${listVmc}" var="vmc">
                                <a href="vmc${vmc.id}-${vmc.typeurl}-${vmc.modelurl}">${vmc.model} (id ${vmc.productid})  </a> <br>
                            </c:forEach> 
<!--                            <p></p>-->
              <br>   <label>  <a href="video">Video</a> </label>
                
                 <c:forEach items="${listVideo}" var="video">
                  <a href="video${video.id}">№ ${video.data} - ${video.headline}</a> <br>
                </c:forEach> 
