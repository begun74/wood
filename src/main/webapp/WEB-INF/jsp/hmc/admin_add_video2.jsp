...
<!--        <div class="box">
    ...
    <h2>Загрузка photo HMC</h2>
    <form class="formBox" method="post" action="add_photo_vmc"  enctype="multipart/form-data">
    <form class="formBox" method="post" action="addHmcPhoto"  enctype="multipart/form-data">
            <fieldset>
        ...
        <div id="tabs" class="box">
            <ul class="bookmarks">
              <li><a href="#tabs-1">11</a></li>
              <li><a href="#tabs-2">Загрузка Video</a></li>
              <li><a href="#tabs-3">333</a></li>
            </ul>
          <div class="box-content">    
            ...
            <div id="tabs-2">
                ...
                <h2>Загрузить Video из Exel</h2>
					<form class="formBox" method="post" action="add_list_video2"
						enctype="multipart/form-data">
						<fieldset>
