...
<html lang="en">
    <head>
        ...
        <meta name="description" content="wishlist milling machins">
                ...
                <div class="container-fluid wishlist_table">
                    ...
                    <div class="row cart-item cart_item" id="yith-wcwl-row-1">
                        ...
                        <div class="col-xs-12 col-sm-1 no-margin">
                            <a title="Remove this product" class="remove_from_wishlist remove-item" href="del-from-wishlist.htm?id=${wishit.product.id}&page=wishlist">x</a>
                        </div>

                        <div class="col-xs-12 col-sm-1 no-margin">
                            <a href="vmc${wishit.product.id}-${wishit.product.typeurl}-${wishit.product.modelurl}.htm">
                        ...
                        <div class="col-xs-12 col-sm-4 no-margin">
                            <div class="title">
                                <a href="vmc${wishit.product.id}-${wishit.product.typeurl}-${wishit.product.modelurl}.htm">${wishit.product.model}</a>
                            </div><!-- /.title --> 
                                <div class="title">
                                    <a href="#">${wishit.product.type}</a>
                                </div>
                            <div>
                                <span class="label label-success wishlist-in-stock">${wishit.product.year} / location:${wishit.product.machinelocation}</span>
                            </div>    
                        </div>
                        
                        <div class="col-xs-12 col-sm-3 no-margin">
                            <div class="price">
                                <span class="amount">${wishit.product.price}</span>                         
                            </div>
                        </div>
<!--                        <div class="col-xs-12 col-sm-3 no-margin">
                            <div class="price">
                                <span class="amount"></span>                         
                                <span class="amount">Location: ${wishit.product.machinelocation}</span>                         
                            </div>
                        </div>-->
                        ...
                        <div class="col-xs-12 col-sm-3 no-margin">
                            <div class="text-right">
                                <div class="add-cart-button">
                                    <a class="le-button add_to_cart_button product_type_simple" href="add-product-to-customer-basket.htm?id=${wishit.product.id}">Add to cart</a>
                                </div>                          
                            </div>
                        </div>
