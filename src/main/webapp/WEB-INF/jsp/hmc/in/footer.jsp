...
<!--        <svg width="233px" height="54px" viewBox="0 0 233 54" version="1.1" xmlns="http://www.w3.org/2000/svg">
    ...
    <p class="regular-bold"> CNC machining center and milling machine.</p>
    ...
    <div class="social-icons">
        ...
        <ul>
                    <li><a href="https://plus.google.com/u/1/b/113654010509282407892/" >
                            <img alt="vmc_and_hmc" src="resources/assets/images/prettyPhoto/google+20.png" width="20"   />
                    </a> </li>
            <li><a href="https://www.youtube.com/channel/UCXZvi4ulrMI7SnJ5vde-BKA" >
                    <img alt="vmc_and_hmc" src="resources/assets/images/prettyPhoto/youtube15.png"  width="21"   />
                </a> </li>
...
<div class="link-widget">
    <div class="widget">
        ...
        <ul>
            ...
            <!--<li><a href="cnc-milling-machine">Cnc milling machine</a></li>-->
    ...
    <div class="copyright-bar">
        <div class="container">
            <div class="col-xs-12 col-sm-6 no-margin">
                <div class="copyright">
                    &copy; <a href="index.htm">VMC & HMC</a> - all rights reserved
                </div><!-- /.copyright -->
            </div>
            <div class="col-xs-12 col-sm-6 no-margin">
