...
-->       <c:forEach var="item" items="${cart.items}">
            <div class="row no-margin cart-item">
                <div class="col-xs-12 col-sm-2 no-margin">
                    <a href="vmc${item.product.id}-${item.product.typeurl}-${item.product.modelurl}.htm" class="thumb-holder">
                ...
                <div class="col-xs-12 col-sm-5 ">
                    <div class="title">
                        <a href="vmc${item.product.id}-${item.product.typeurl}-${item.product.modelurl}.htm">${item.product.model}</a>
                    </div>
                    <div class="brand">${item.product.year} / location: ${item.product.machinelocation}</div>
                </div> 
            ...
            <div class="widget cart-summary">
                ...
                <div class="body">
                    ...
                    <div class="buttons-holder">
                        <a class="le-button big" href="checkout.htm" >checkout</a>
