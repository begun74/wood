...
<!-- /.widget -->
    ...
    <div class="body">
        <ul class="le-links">
            ...
            <li><a href="video2">All</a></li>
            <c:forEach items="${listSection}" var="section">       
            <li><a href="video2?section=${section.section}">${section.section}</a></li>
<!--            <li><a href="video?section=service">Service</a></li>
            <li><a href="video?section=vmc">Vertical machining centers</a></li>
            <li><a href="video?section=5 axis">Machining centers 5 axis</a></li>
            <li><a href="video?section=hmc">Horizontal machining centers</a></li>
            <li><a href="video?section=lathe cnc">Lathe CNC</a></li>-->
            </c:forEach>
        </ul><!-- /.le-links -->
    </div>
</div><!-- /.widget -->
