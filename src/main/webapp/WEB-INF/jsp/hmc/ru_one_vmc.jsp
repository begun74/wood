            ...
            <ul class="inline">
                <li class="dropdown le-dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="vmc.htm">Вертикальный обрабатывающий центр</a></li>
...
<!--                        <li class="dropdown breadcrumb-item">
                        ...
                        <li class="breadcrumb-item">
                            <a href="vmc.htm">Vertical machine center</a>
                        </li> 
                        <!--/.breadcrumb-item--> 

                        <li class="breadcrumb-item current">
                            <a href="">${hmc.producer} - ${hmc.model}</a>
                        </li> 
                        <!--/.breadcrumb-item--> 
                    </ul>
                </li> 
    ...
    <div class="product-item-holder size-big single-product-gallery small-gallery">
        ...
        <div id="owl-single-product">
            <div class="single-product-gallery-item" id="slide1">
                <a data-rel="prettyphoto" href="resources/assets/images/products/${hmc.photo1}">
                    <img class="img-responsive" alt="" 
                         src="resources/assets/images/products/${hmc.photo1}" 
                         data-echo="resources/assets/images/products/${hmc.photo1}" />
                         <!--src="resources/assets/images/blank.gif"--> 
                </a>
            </div><!-- /.single-product-gallery-item -->
            
            <div class="single-product-gallery-item" id="slide2">
                <a data-rel="prettyphoto" href="resources/assets/images/products/${hmc.photo2}">
                    <img class="img-responsive" alt="" 
                         src="resources/assets/images/products/${hmc.photo2}" 
                         data-echo="resources/assets/images/products/${hmc.photo2}" />
                         <!--src="resources/assets/images/blank.gif"--> 
                </a>
            </div><!-- /.single-product-gallery-item -->
            
            <div class="single-product-gallery-item" id="slide3">
                <a data-rel="prettyphoto" href="resources/assets/images/products/${hmc.photo3}">
                    <img class="img-responsive" alt="" 
                         src="resources/assets/images/products/${hmc.photo3}" 
                         data-echo="resources/assets/images/products/${hmc.photo3}" />
                         <!--src="resources/assets/images/blank.gif"--> 
                </a>
            </div><!-- /.single-product-gallery-item -->
        ...
        <div class="single-product-gallery-thumbs gallery-thumbs">
            ...
            <div id="owl-single-product-thumbnails">
                <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="0" href="#slide1">
                    <!--<img width="67" alt="" src="resources/assets/images/blank.gif" data-echo="resources/assets/images/products/bench${hmc.id}.jpg" />-->
                    <img width="67" alt="" src="resources/assets/images/products/${hmc.photo1}" data-echo="resources/assets/images/products/${hmc.photo1}" />
                </a>
                ...
                <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="1" href="#slide2">
                    ...
                    <img width="67" alt=""  src="resources/assets/images/products/${hmc.photo2}" data-echo="resources/assets/images/products/${hmc.photo2}"  />
                </a>

                <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="2" href="#slide3">
                    <!--<img width="67" alt="" src="resources/assets/images/blank.gif" data-echo="resources/assets/images/products/bench${hmc.id}.jpg" />-->
                    <img width="67" alt=""  src="resources/assets/images/products/${hmc.photo3}" data-echo="resources/assets/images/products/${hmc.photo3}"  />
                </a>
<!--                <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="2" href="#slide3">
                    <img width="67" alt="" src="resources/assets/images/blank.gif" data-echo="resources/assets/images/products/bench${hmc.id}.jpg" />
...
<!--                <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="2" href="#slide3">
    ...
    <div class="body">
        ...
        <div class="title"><a href="#">${hmc.type} - ${hmc.model}</a></div>
        <div class="brand">${hmc.year} / Location: ${hmc.benchLocation} </div>
...
<!--            <div class="le-quantity">
            ...
            <a id="addto-cart" href="add-product-to-customer-basket.htm?id=${hmc.id}" class="le-button huge">add to cart</a>
        </div><!-- /.qnt-holder -->
    </div><!-- /.body -->
                ...
                <div class="tab-pane" id="additional-info">
                    <ul class="tabled-data">
                        <li>
                            ...
                            <div class="value">${hmc.producer}</div>
                            
                        </li>
                        <li>
                            <label>Страна производитель</label>
                            <div class="value">${hmc.country}</div>
                        </li>
                        <li>
                            <label>ЧПУ</label>
                            <div class="value">${hmc.cncSystemFull}</div>
                        </li>
                        <li>
                            <label>Год</label>
                            <div class="value">${hmc.year}</div>
                        </li>
                        <li>
                            <label>Местонахождения</label>
                            <div class="value">${hmc.benchLocation}</div>
                        </li>
                        <li>
                            <label>Кол-во осей</label>
                            <div class="value">${hmc.axisCount}</div>
                        </li>
                        <li>
                            <label>Перемещение по оси - X</label>
                            <div class="value">${hmc.xMotion}</div> mm
                        </li>
                        <li>
                            <label>Перемещение по оси - Y</label>
                            <div class="value">${hmc.yMotion}</div>
                        </li>
                        <li>
                            <label>Перемещение по оси - Z</label>
                            <div class="value">${hmc.zMotion}</div>
                        </li>
                        <li>
                            <label>Размер стола - X, мм</label>
                            <div class="value">${hmc.descSizeX}</div>
                        </li>
                        <li>
                            <label>Размер стола - Y, мм</label>
                            <div class="value">${hmc.descSizeY}</div>
                        </li>
                        <li>
                            <label>Нагрузка на стол, кг</label>
                            <div class="value">${hmc.descLoad}</div>
                        </li>
                        <li>
                            <label>Конус шпинделя</label>
                            <div class="value">${hmc.spindleCone}</div>
                        </li>
                        <li>
                            <label>Частота вращения шпинделя, об/мин</label>
                            <div class="value">${hmc.spindleFreq}</div>
                        </li>
                        <li>
                            <label>Мощность шпинделя, kw</label>
                            <div class="value">${hmc.spindlePow}</div>
                        </li>
                        <li>
                            <label>Максимальный крутящий момент шпинделя</label>
                            <div class="value">${hmc.spindleMaxTorque}</div>
                        </li>
                        <li>
                            <label>Тип шпинделя </label>
                            <div class="value">${hmc.spindleType}</div>
                        </li>
                        <li>
                            <label>Спосод охлаждения шпинделя</label>
                            <div class="value">${hmc.spindleCooling}</div>
                        </li>
                        <li>
                            <label>Тип магазина </label>
                            <div class="value">${hmc.magType}</div>
                        </li>
                        <li>
                            <label>Кол-во инструментов, шт</label>
                            <div class="value">${hmc.toolCount}</div>
                        </li>
                        <li>
                            <label>Максимальный диаметр инструмента в магазине, мм</label>
                            <div class="value">${hmc.toolMaxD}</div>
                        </li>
                        <li>
                            <label>Максимальный вес инструмента, кг</label>
                            <div class="value">${hmc.toolMaxW}</div>
                        </li>
                        <li>
                            <label>Время смены инструмента, сек</label>
                            <div class="value">${hmc.toolRepTime}</div>
                        </li>
                        <li>
                            <label>Точность позиционирования, мм</label>
                            <div class="value">${hmc.posPrecision}</div>
                        </li>
                        <li>
                            <label>Точность Re-позиционирования, мм</label>
                            <div class="value">${hmc.reposPrecision}</div>
                        </li>
                        <li>
                            <label>Наработка на шпинделе, ч</label>
                            <div class="value">${hmc.spindleRuntime}</div>
                        </li>
                        <li>
                            <label>Включение станка всего, ч</label>
                            <div class="value">${hmc.benchLaunches}</div>
                        </li>
                        <li>
                            <label>Дополнительно в комплектации</label>
                            <div class="value">${hmc.equipment}</div>
                        </li>
                        <li>
                            <label>Состояние станка</label>
                            <div class="value">${hmc.benchCondition}</div>
                        </li>
                        <li>
                            <label>Описание станка</label>
                            <div class="value">${hmc.info1}</div>
                        </li>
