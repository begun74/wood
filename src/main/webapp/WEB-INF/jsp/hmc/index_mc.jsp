...
<div class="row">
 ...
 ================================== MEGAMENU VERTICAL ==================================     
            ...
            <!--all departments-->
            <!--<li><a href="vertical-machining-centres.htm">Vertical machining centers</a></li>-->
<!--            <li><a href="cnc-milling-machine">Cnc milling machines</a></li>
            <li><a href="drill-end-mill-grinder">Drill, end mill grinder</a></li>-->
            
            <%@include file="in/all_departments.jsp" %>
...
<!--        <div class="item" style="background-image: url(resources/assets/images/sliders/flag-russia.jpg);">
            <div class="container-fluid">
             ...
             Вперёд!<span class="big"><span class="sign"></span>Россия </span>
                    ...
                    <div class="excerpt fadeInDown-2">
                        Наши контакты:<br>+7 (903) 930-22-24<br>
                        +7 (903) 506-04-24 <br> 
                        ...
                        <div class="col-sm-4 col-md-3  no-margin product-item-holder hover">
                            ...
                            <div class="product-item">
                                ...
                                <div class="image">
                                    ...
                                    <a href="vmc${vmc.id}-${vmc.typeurl}-${vmc.modelurl}.htm"> 
                                ...
                                <div class="body">
                                    ...
                                    <div class="title">
                                        <a href="vmc${vmc.id}-${vmc.typeurl}-${vmc.modelurl}.htm"> ${vmc.model}</a>
                                    </div>
...
<section id="recently-reviewd" class="wow fadeInUp">
    <div class="container">
        <div class="carousel-holder hover">
            ...
            <div class="title-nav">
                <h2 class="h1">CNC milling machines and machining centers - Video</h2>
            ...
            <c:forEach items="${listVideo}" var="video"> 
                <div class="no-margin carousel-item product-item-holder size-small hover">
                    <div class="product-item">
                        ...
                        <div class="image">
                          <iframe width="194" height="143" src="${video.link_embed}" frameborder="0" allowfullscreen></iframe>      
                        </div>
                        <div class="body">
                            <div class="title">
                                <a href="video${video.id}">${video.headline}</a>
                            </div>
        ...
        <div class="carousel-holder" >
            ...
            <div id="owl-brands" class="owl-carousel brands-carousel">
                ...
                <div class="carousel-item">
                    <a href="cnc-milling-machine?dmg=1">
                ...
                <div class="carousel-item">
                    <a href="cnc-milling-machine?moriseiki=1">
                        <img alt="MORI SEIKI" src="resources/assets/images/brands/brand_mori_seiki.jpg" />
                    </a>
                </div> 
                <!--/.carousel-item--> 
                
<!--                <div class="carousel-item">
                    <a href="cnc-milling-machine2?mazak=1">
                        <img alt="" src="resources/assets/images/brands/brand_Mazak.jpg" />
                    </a>
                </div> -->
              
                
                <div class="carousel-item">
                    <a href="cnc-milling-machine?haas=1">
                        <img alt="HAAS" src="resources/assets/images/brands/brand_haas.jpg" />
                    </a>
                </div> 
                <!--/.carousel-item--> 
