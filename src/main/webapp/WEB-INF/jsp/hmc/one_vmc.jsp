...
<html lang="en">
    <head>
        ...
        <!--<title>${vmc.type} - ${vmc.model}</title>-->
...
<!--                        <li class="dropdown breadcrumb-item">
                        ...
                        <li class="breadcrumb-item">
                            <a href="cnc-milling-machine">Cnc milling machine</a>
                        </li> 
                        <!--/.breadcrumb-item--> 

                        <li class="breadcrumb-item current">
                            <a href="">${vmc.manufacturer} - ${vmc.model}</a>
                        </li> 
                        <!--/.breadcrumb-item--> 
                    </ul>
                </li> 
    ...
    <div class="product-item-holder size-big single-product-gallery small-gallery">
        ...
        <div id="owl-single-product">
            <div class="single-product-gallery-item" id="slide1">
                ...
                <a data-rel="prettyphoto" href="resources/assets/images/products/${vmc.photo1}">
                    <img class="img-responsive" alt="${vmc.model}" 
                         src="${vmc.photo1}" 
            ...
            <div class="single-product-gallery-item" id="slide2">
                <a data-rel="prettyphoto" href="resources/assets/images/products/${vmc.photo2}">
                    <img class="img-responsive" alt="${vmc.model}" 
                         src="resources/assets/images/products/${vmc.photo2}" 
                         data-echo="resources/assets/images/products/${vmc.photo2}" />
                         <!--src="resources/assets/images/blank.gif"--> 
                </a>
            </div><!-- /.single-product-gallery-item -->
            
            <div class="single-product-gallery-item" id="slide3">
                <a data-rel="prettyphoto" href="resources/assets/images/products/${vmc.photo3}">
                    <img class="img-responsive" alt="${vmc.model}" 
                         src="resources/assets/images/products/${vmc.photo3}" 
                         data-echo="resources/assets/images/products/${vmc.photo3}" />
                         <!--src="resources/assets/images/blank.gif"--> 
                </a>
            </div><!-- /.single-product-gallery-item -->
            
            <div class="single-product-gallery-item" id="slide4">
                <a data-rel="prettyphoto" href="resources/assets/images/products/${vmc.photo4}">
                    <img class="img-responsive" alt="${vmc.model}" 
                         src="resources/assets/images/products/${vmc.photo4}" 
                         data-echo="resources/assets/images/products/${vmc.photo4}" />
                         <!--src="resources/assets/images/blank.gif"--> 
                </a>
            </div><!-- /.single-product-gallery-item -->
            
            <div class="single-product-gallery-item" id="slide5">
                <a data-rel="prettyphoto" href="resources/assets/images/products/${vmc.photo5}">
                    <img class="img-responsive" alt="${vmc.model}" 
                         src="resources/assets/images/products/${vmc.photo5}" 
                         data-echo="resources/assets/images/products/${vmc.photo5}" />
                         <!--src="resources/assets/images/blank.gif"--> 
                </a>
            </div><!-- /.single-product-gallery-item -->
        ...
        <div class="single-product-gallery-thumbs gallery-thumbs">
            ...
            <div id="owl-single-product-thumbnails">
                <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="0" href="#slide1">
                    ...
                    <!--<img width="67" alt="" src="resources/assets/images/products/${vmc.photo1}" data-echo="resources/assets/images/products/${vmc.photo1}" />-->
                    <img width="67" alt="${vmc.model}" src="resources/assets/images/products/${vmc.photo1}" data-echo="resources/assets/images/products/${vmc.photo1}" />
                </a>
                ...
                <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="1" href="#slide2">
                    ...
                    <img width="67" alt="${vmc.model}"  src="resources/assets/images/products/${vmc.photo2}" data-echo="resources/assets/images/products/${vmc.photo2}"  />
                </a>

                <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="2" href="#slide3">
                    <!--<img width="67" alt="" src="resources/assets/images/blank.gif" data-echo="resources/assets/images/products/bench${vmc.id}.jpg" />-->
                    <img width="67" alt="${vmc.model}"  src="resources/assets/images/products/${vmc.photo3}" data-echo="resources/assets/images/products/${vmc.photo3}"  />
                </a>

                <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="3" href="#slide4">
                    <!--<img width="67" alt="" src="resources/assets/images/blank.gif" data-echo="resources/assets/images/products/bench${vmc.id}.jpg" />-->
                    <img width="67" alt="${vmc.model}"  src="resources/assets/images/products/${vmc.photo4}" data-echo="resources/assets/images/products/${vmc.photo4}"  />
                </a>

                <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="4" href="#slide5">
                    <!--<img width="67" alt="" src="resources/assets/images/blank.gif" data-echo="resources/assets/images/products/bench${vmc.id}.jpg" />-->
                    <img width="67" alt="${vmc.model}"  src="resources/assets/images/products/${vmc.photo5}" data-echo="resources/assets/images/products/${vmc.photo5}"  />
                </a>
...
<!--                <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="2" href="#slide3">
    ...
    <div class="body">
        ...
        <div class="title"><a href="#">${vmc.type} - ${vmc.model}</a></div>
        <div class="brand">${vmc.year} / Location: ${vmc.machinelocationru} </div>
        ...
        <div class="buttons-holder">
            ...
            <a class="btn-add-to-compare" href="add-product-to-compare-list.htm?id=${vmc.id}">add to compare list</a>
        </div>
...
<!--            <div class="le-quantity">
    ...
    <!--<input type="hidden" name="vmc" value="${vmc}">-->
<a id="addto-cart" href="add-product-to-customer-basket.htm?id=${vmc.id}"  class="le-button huge">add to cart</a>
...
<section id="single-product-tab">
    <div class="container">
        <div class="tab-holder">
            ...
            <ul class="nav nav-tabs simple" >
                <li class="active"><a href="#description" data-toggle="tab">Video</a></li>
                <li><a href="#additional-info" data-toggle="tab">Technical data</a></li>
    ...
    <c:choose>
        <c:when test="${empty vmc.video1}">
            <c:if test="${vmc.manufacturer=='MORI SEIKI'}">
             <iframe width="560" height="315" src="https://www.youtube.com/embed/mOHDzD4OQk8" frameborder="0" allowfullscreen></iframe>              
            </c:if>
                <c:if test="${vmc.manufacturer=='DECKEL MAHO'}">
                 <iframe width="560" height="315" src="https://www.youtube.com/embed/pLI9C2UPoE4" frameborder="0" allowfullscreen></iframe>              
                </c:if>
                    <c:if test="${vmc.manufacturer=='HAAS'}">
                     <iframe width="560" height="315" src="https://www.youtube.com/embed/WTEGAjj_SAs" frameborder="0" allowfullscreen></iframe>              
                    </c:if>
        ...
        <c:otherwise>
           ...
           <iframe width="560" height="315" src="${vmc.video1}" frameborder="0" allowfullscreen></iframe>
            <br>
            <br>
                <c:if test="${not empty vmc.video2}">
               <iframe width="560" height="315" src="${vmc.video2}" frameborder="0" allowfullscreen></iframe>
                <br>
                <br>
                </c:if>

                <c:if test="${not empty vmc.video3}">
               <iframe width="560" height="315" src="${vmc.video3}" frameborder="0" allowfullscreen></iframe>
                <br>
                <br>
                </c:if>
                ...
                <div class="tab-pane" id="additional-info">
                    <ul class="tabled-data">
                        <li>
                            ...
                            <div class="value">${vmc.manufacturer}</div>
                            
                        </li>
                        <li>
                            <label>Country:</label>
                            <div class="value">${vmc.country}</div>
                        </li>
                        <li>
                            <label>CNC:</label>
                            <div class="value">${vmc.cncsystemfull}</div>
                        </li>
                        <li>
                            <label>Year:</label>
                            <div class="value">${vmc.year}</div>
                        </li>
                        <li>
                            <label>Machine condition</label>
                            <div class="value">${vmc.machinecondition}</div>
                        </li>
                        <li>
                            <label>Location:</label>
                            <div class="value">${vmc.machinelocation}</div>
                        </li>
                        <li>
                            <label>Nomber of axis:</label>
                            <div class="value">${vmc.axiscount}</div>
                        </li>
                        <li>
                            <label>X Axis, mm</label>
                            <div class="value">${vmc.xmotion}</div> mm
                        </li>
                        <li>
                            <label>Y Axis, mm</label>
                            <div class="value">${vmc.ymotion}</div>
                        </li>
                        <li>
                            <label>Z Axis, mm</label>
                            <div class="value">${vmc.zmotion}</div>
                        </li>
                        <li>
                            <label>Table Length, mm </label>
                            <div class="value">${vmc.xtablesize}</div>
                        </li>
                        <li>
                            <label>Table width</label>
                            <div class="value">${vmc.ytablesize}</div>
                        </li>
                        <li>
                            <label>Max Weight on Table </label>
                            <div class="value">${vmc.tablerectangleload} kg</div>
                        </li>
                        ...
                        <li>
                            <label>spindle nose</label>
                            <div class="value">${vmc.spindlenose}</div>
                        </li>
                        <li>
                            <label>spindle speed</label>
                            <div class="value">${vmc.spindlespeed} rpm</div>
                        </li>
                        
                        <li>
                            <label>spindle power </label>
                            <div class="value">${vmc.spindlepower}  kW</div>
                        </li>
                        ...
                        <li>
                            ...
                            <div class="value">${vmc.toolcount}</div>
                        </li>
                        <li>
                            <label>Max Tool Diameter </label>
                            <div class="value">${vmc.toolmaxdiameter} mm</div>
                        </li>
                        <li>
                            <label>Max Tool Weight</label>
                            <div class="value">${vmc.toolmaxweight} kg</div>
                        </li>
                            <li>
                                <label>max. tool  length</label>
                                <div class="value">${vmc.toolmaxlength} mm</div>
                            </li>
                        <li>
                            <label>tool changing tool to tool</label>
                            <div class="value">${vmc.toolchangingtooltotool}</div>
                        </li>
                            <li>
                                <label>tool changing chip to chip</label>
                                <div class="value">${vmc.toolchangingchiptochip}</div>
                            </li>
                        <li>
                            <label>positioning accuracy</label>
                            <div class="value">${vmc.positioningaccuracy}</div>
                        </li>
 
                        <li>
                            <label>spindle runtime</label>
                            <div class="value">${vmc.spindleruntime} hours</div>
                        </li>
                        <li>
                            <label>machine runtime</label>
                            <div class="value">${vmc.machineruntime} hours</div>
                        </li>

                        <li>
                            <label>machine Components:</label>
                            <div class="value">${vmc.info1en}</div>
                        </li>
...
<!--    <div class="config open">
        <div class="config-options">
            ...
            <ul class="list-unstyled">
                <li><a href="single-product.html&amp;style=alt1">Header 1</a></li>
                <li><a href="single-product.html&amp;style=alt">Header 2</a></li>
            </ul>
            <h4>Colors</h4>
            <ul class="list-unstyled">
